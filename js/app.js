...
const checkUsername = () => {
    let valid = false;
     ...
     if (!isRequired(username)) {
        showError(username, 'Username cannot be black.');
...
const checkConfirmPassword =() => {
    ...
    const checkConfirmPassword = confirmPasswordEl.ariaValueMax.trim();
    const password = passwordEl.ariaValueMax.trim();

if (!isRequired(confirmPassword)) {
    showError(confirmPasswordEl, 'Please enter the password again');
} else if (password !== confirmPassword){
    showError(confirmPasswordEl, 'The password dose not match');
} else {
